import { PopularProduct, ReviewUser, ProductCard } from "../../components/atoms/Card";
...
const products = [
    { id: 1, name: "Tenda 2L Kap. 4-5P Naturhike", image: Product1, description: "Tenda yang kokoh dan nyaman untuk 4-5 orang.", link: "#" },
    { id: 2, name: "Tenda 2L Kap. 6-7P Forester", image: Product2, description: "Tenda luas untuk 6-7 orang.", link: "#" },
    { id: 3, name: "Headlamp", image: Product3, description: "Lampu kepala dengan pencahayaan terang.", link: "#" },
    { id: 4, name: "Lampu Tenda Bakpao", image: Product4, description: "Lampu tenda yang hemat energi.", link: "#" },
    { id: 5, name: "Tenda 2L Kap. 4-5P Borneo", image: Product5, description: "Tenda yang cocok untuk keluarga kecil.", link: "#" },
    { id: 6, name: "Tenda EXL CHANODOUG KAP. 12 P", image: Product5, description: "Tenda besar untuk 12 orang.", link: "#" },
];
            ...
            <div className="flex justify-center items-center flex-col">
                <div className="text-center xl:text-left xl:px-20">
                    ...
                    <div className="flex gap-4 justify-center items-center">
                        <div>
                            <h1 className="font-bold text-primary text-[56px] text-left mr-5 hidden xl:block xl:w-full">Sewa Alat Camping Terbaik Malang Raya</h1>
                            <p className="text-neutral text-[18px] pt-5 xl:w-full">Jadikan petualanganmu berkesan</p>
                            <div className="flex gap-5">
                                <PrimaryButton text="Cara Pemesanan" className="mt-10 w-60 h-14 rounded-[5rem] hidden xl:block" />
                                <OutlineButton text="Hubungi Admin" className="mt-10 w-60 h-14 rounded-full hidden xl:block" />
                            </div>
                        </div>
                        <img src={ImgHerosectiondesktop} alt="img-gunung" className="rounded-tl-3xl rounded-tr-3xl hidden xl:block" />
                    </div>
                    <p className="text-neutral text-md pt-5 xl:hidden">Jadikan petualanganmu berkesan</p>
                    <div className="pt-10">
                        <img src={ImgHerosection} alt="img-gunung" className="rounded-tl-3xl rounded-tr-3xl xl:hidden" />
                    </div>
                    <PrimaryButton text="Cara Pemesanan" className="mt-10 w-60 h-14 rounded-[5rem] xl:hidden" />
                    <OutlineButton text="Hubungi Admin" className="mt-4 w-60 h-14 rounded-full xl:hidden" />
                </div>
                <div className="text-center pt-10">
                    <h1 className="font-bold text-primary text-2xl">Produk Terpopuler</h1>
                    <p className="text-md mt-5 w-96 xl:w-[35rem] text-neutral">Kami selalu menyediakan peralataan outdoor terbaik untuk menunjang pengalaman konsumen ketika berpetualang</p>
                </div>
                ...
                <PrimaryButton text="Selengkapnya" className="mt-16 w-full h-14 rounded-[5rem] xl:w-40 xl:rounded-[5rem]" />
                ...
                <div className="text-center pt-12">
                    ...
                    <div className="flex justify-center items-center pt-5 gap-5">
                        <input type="text" placeholder="Cari" className="w-full max-w-md p-2 border border-gray-300 rounded-[5rem]focus:outline-none focus:ring-2 focus:ring-secondary text-left xl:max-w-full " />
                        <PrimaryButton text="Filter" className="rounded-[5rem] w-24" />
                    </div>
                    <p className="text-md pt-10 text-neutral mb-5 xl:mb-0">Peralatan outdoor dengan standar yang baik menjadi fokus kami, karena keselamatan dan kenyamanan adalah faktor penting</p>
                </div>
                ...
                <PrimaryButton text="Selengkapnya" className="mt-16 w-full h-14 rounded-[5rem] xl:hidden" />
