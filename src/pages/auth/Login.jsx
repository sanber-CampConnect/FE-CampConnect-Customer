    ...
    <div className="flex flex-col xl:flex-row items-center justify-center min-h-screen bg-white">
      <div className="hidden xl:flex flex-1 items-center justify-center h-full relative">
        <div className="absolute -top-28 left-20">
          <img src={Logo} alt="Your Logo" className="w-20" />
        </div>
        <div className="w-2/3 h-2/3 flex items-center justify-center">
          <img src={ImgPlaceholder} alt="Placeholder" className="w-full h-full object-contain" />
        </div>
      </div>
      <div className="w-full max-w-xl mx-auto mr-10 p-8 xl:w-1/2">
        ...
        <div className="font-poppins text-left mt-6 ">
          ...
          <p className="font-medium text-base mt-3">
            ...
            You can <a href="#" className="text-red-600">Register here!</a>
          </p>
        </div>
        <form className="space-y-6 pt-12">
          ...
          <div className="relative">
            ...
            <div className="flex items-center mt-1 relative">
              <img src={IconLock} alt="lock icon" className="absolute left-3 w-4 h-4 text-black" />
              <input
              ...
              <div className="absolute right-3 cursor-pointer" onClick={togglePasswordVisibility}>
                {passwordVisible ? <FaEyeSlash className="w-5 h-5 text-black" /> : <IoEyeSharp className="w-5 h-5 text-black" />}
              </div>
            </div>
          </div>
          <div className="flex items-start justify-between mt-2">
            ...
            <div className="flex items-start">
              <a href="#" className="text-sm text-gray-600 hover:underline hover:text-indigo-600">
                Forgot <br /> Password?
              </a>
            </div>
          </div>
