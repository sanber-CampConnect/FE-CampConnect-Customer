...
const Checkout = () => {
    ...
    const totalBarang = cartItems.reduce((sum, item) => sum + item.jumlahBarang, 0);
    const subtotal = cartItems.reduce((sum, item) => sum + item.harga * item.jumlahBarang, 0);
    ...
    return (
        <>
                ...
                <div className="w-full max-w-xl mx-auto p-4">
                        ...
                        >
                            <Option value="Cash">
                                <div className="flex items-center">
                                    <img src={iconPayment} alt="Cash" className="w-4 h-4 mr-2" />
                                    Cash
                                </div>
                            </Option>
                            <Option value="Bank Transfer">
                                <div className="flex items-center">
                                    <img src={iconPayment} alt="Bank Transfer" className="w-4 h-4 mr-2" />
                                    Transfer
                                </div>
                            </Option>
                        </Select>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex justify-between">
                            ...
                            <p className="font-bold">{biayaPengiriman === 0 ? "Gratis" : `Rp${numberWithCommas(biayaPengiriman)}`}</p>
                        </div>
                    ...
                    <div className="flex justify-between mt-10 mb-10">
                        <OutlineButton text="Batalkan" className="w-1/2 mr-2 border border-primary"/>
                        <PrimaryButton text="Bayar" className="w-1/2 ml-2" />
                    </div>
                </div>
            </div>
            ...
            <div className="hidden xl:flex xl:flex-col xl:container xl:mx-auto xl:p-4">
                <div className="w-full max-w-7xl mx-auto p-4"><h2 className="text-xl font-semibold mb-4">Keranjang Anda</h2><h1 className="text-3xl font-bold mb-6"></h1>
                    <div className="flex space-x-8">
                                    ...
                                    <tbody>
                                        {cartItems.map((item) => (
                                            <tr key={item.id}>
                                                ...
                                                <td className="py-2 px-4 text-center">{item.jumlahBarang}</td>
                        ...
                        <div className="w-1/3">
                            ...
                            <div className="flex gap-6  mt-10">
                                <a href="/cart">
                                <OutlineButton text="Batalkan" className="w-full border-primary" />
                                </a>
                                <PrimaryButton text="Checkout" className="w-full" />
                            </div>
                        </div>
                    </div>
                </div>
