  ...
  return (
    <>
      <div className="flex flex-col justify-center mx-4">
        <div className="flex flex-row text-md text-neutral justify-end gap-2 mb-4">
          <p>Kategori:</p>
        ...
        <div className="flex flex-row justify-between gap-6 items-center my-6">
          <h4 className="text-lg font-medium text-justify">
        ...
        <div className="w-fit text-primary text-md mb-4">
        ...
        <div className="flex flex-row justify-between items-center mb-6">
          ...
          <div className="stock flex flex-col w-fit text-[#808080] gap-2 items-center">
        ...
        <PrimaryButton text="Masukkan Keranjang" className="w-full py-3" />
      </div>
    </>
  );
};
